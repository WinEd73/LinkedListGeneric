...
//ITERATOR
    public class ForwardtIterator implements Iterator<G>{
        private Node<G> currentNode;

        public ForwardtIterator() {
            this.currentNode = head;
        }

        public ForwardtIterator(ForwardtIterator forwardtIterator){
            currentNode = forwardtIterator.currentNode;
        }
...
//REVERSEITERATOR
    ...
    public void insert(G data, Position position, Iterator<G> it) {
        ...
        Node<G> currentNode = ((ForwardtIterator)it).getCurrentNode();
